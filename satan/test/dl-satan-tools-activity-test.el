;;; dl-satan-tools-activity-test.el --- ert tests for dl-satan-tools-activity -*- lexical-binding: t; -*-

;; Run from CLI:
;;   emacs --batch \
;;     -L ~/.emacs.d/core -L ~/.emacs.d/satan -L ~/.emacs.d/satan/test \
;;     -l dl-satan-tools-activity-test.el -f ert-run-tests-batch-and-exit
...
(defmacro dl-satan-tools-activity-test--with-root (&rest body)
...
(defun dl-satan-tools-activity-test--today ()
  (format-time-string "%Y-%m-%d"))

(defun dl-satan-tools-activity-test--write-histogram (dir payload)
  (let ((path (expand-file-name
               (format "histograms/daily-%s.json"
                       (dl-satan-tools-activity-test--today))
               dir)))
    (with-temp-file path (insert payload))
    path))

(defun dl-satan-tools-activity-test--write-focus-jsonl (dir lines)
  (let ((path (expand-file-name
...
(defun dl-satan-tools-activity-test--write-browser-jsonl (dir lines)
  (let ((path (expand-file-name
...
(defun dl-satan-tools-activity-test--write-current-sway (dir payload)
...
(ert-deftest dl-satan-activity/today-returns-parsed-histogram ()
  ...
  (dl-satan-tools-activity-test--with-root
    (dl-satan-tools-activity-test--write-histogram
...
(ert-deftest dl-satan-activity/recent-focus-returns-tail ()
  ...
  (dl-satan-tools-activity-test--with-root
    (dl-satan-tools-activity-test--write-focus-jsonl
     dl-satan-tools-activity-dir
...
(ert-deftest dl-satan-activity/recent-browser-returns-tail ()
  ...
  (dl-satan-tools-activity-test--with-root
    (dl-satan-tools-activity-test--write-browser-jsonl
     dl-satan-tools-activity-dir
...
(ert-deftest dl-satan-activity/current-returns-window-snapshot ()
  ...
  (dl-satan-tools-activity-test--with-root
    (dl-satan-tools-activity-test--write-current-sway
     dl-satan-tools-activity-dir
...
(provide 'dl-satan-tools-activity-test)
;;; dl-satan-tools-activity-test.el ends here
