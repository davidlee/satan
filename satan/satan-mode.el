;;; satan-mode.el --- SATAN mode registry -*- lexical-binding: t; -*-
...
(defun satan-mode-resolve (name)
  "Return the mode-spec named NAME, or signal if unknown."
  (or (cdr (assoc name satan-modes))
      (error "Unknown SATAN mode: %s" name)))

(defun satan-mode-names ()
  (mapcar #'car satan-modes))

(defun satan-mode-check-tool-references ()
...
hard error so typos surface at startup rather than at dispatch."
  (let ((registered (mapcar #'car satan-tools))
        (errors nil))
    (dolist (entry satan-modes)
...
(satan-mode-register
 (list :name "morning"
       :prompt-file (expand-file-name "morning.txt" satan-prompts-dir)
       :context-fn 'satan-context-morning
...
(satan-mode-register
 (list :name "motd"
       :prompt-file (expand-file-name "motd.txt" satan-prompts-dir)
       :context-fn 'satan-context-motd
...
(satan-mode-register
 (list :name "self-edit-mech"
       :prompt-file (expand-file-name "self-edit-mech.txt" satan-prompts-dir)
       :context-fn 'satan-context-self-edit
       :source-roots-var 'satan-self-edit-mech-roots
...
(satan-mode-register
 (list :name "self-edit-mind"
       :prompt-file (expand-file-name "self-edit-mind.txt" satan-prompts-dir)
       :context-fn 'satan-context-self-edit
       :source-roots-var 'satan-self-edit-mind-roots
       :tools '("proposal_stage" "sway_border_set" "sway_border_reset"
                "hippocampus_list" "hippocampus_read" "hippocampus_write"
                "hippocampus_overwrite" "hippocampus_delete"
                "hippocampus_grep" "hippocampus_rename"
...
(satan-mode-register
 (list :name "ruminate"
       :prompt-file (expand-file-name "ruminate.txt" satan-prompts-dir)
       :context-fn 'satan-context-motd
