...
It's a local, Emacs-mediated, org-backed, harness-agnostic agent
runtime. Satan that periodically reads irresponsibly personal context,
reasons over it through a model/harness, and produces bounded,
inspectable effects through a trusted broker. 

It reads time-series data on browser history, git and window manager activity (sway / niri) 
